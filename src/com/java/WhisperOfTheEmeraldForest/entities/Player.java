...
public class Player {
    ...
    private static final String[] DAMAGE_GRUNT_SOUNDS = {
        "Sound/SFX/Grunt/01. Damage Grunt (Male).wav",
        "Sound/SFX/Grunt/02. Damage Grunt (Male).wav",
        "Sound/SFX/Grunt/03. Damage Grunt (Male).wav"
    };
    ...
    private static final float HURT_DURATION = 0.32f;
    ...
    private BufferedImage hurtTexture;
    ...
    public Player() {
        ...
        hurtTexture = Assets.load("ASSETSGame/FreeKnight_v1/Colour2/NoOutline/120x80_PNGSheets/_Hit.png");
        ...
        hurtAnimation = createSheetAnimation(hurtTexture, 0.08f);
    ...
    private void playRandomDamageGrunt() {
        int index = ThreadLocalRandom.current().nextInt(DAMAGE_GRUNT_SOUNDS.length);
        OneShotSound.play(DAMAGE_GRUNT_SOUNDS[index]);
    }
}
