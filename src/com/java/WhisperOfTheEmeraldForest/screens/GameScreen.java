...
public class GameScreen implements Screen {
    ...
    private static final float MAP2_SPAWN_X = 40f;
    private static final float MAP2_SPAWN_Y = 140f;
    private static final String GAME_MUSIC_PATH = "Sound/BGS Loops/Forest Day/Forest Day.wav";
    ...
    public GameScreen(Core game) {
        this.game = game;
        this.pauseOverlay = new PauseOverlay(game, 1);
    ...
    @Override
    public void onShow() {
        music.play(GAME_MUSIC_PATH);
        map = new TmxMapLoader().load("ASSETSGame/forest-nature-fantasy-tileset-free/Fantasy Swamp Forest/Free/Free.tmx");
        ...
        orcs.clear();
        orcs.add(new OrcEnemy(560f, 200f, 140f));
        potions.clear();
    ...
    public void update(float delta) {
        ...
        if (!pauseOverlay.isPaused()) {
            ...
            game.setScreen(new DeathScreen(game, 1, player.getDeathReason(), getDeathMessage(player.getDeathReason())));
                return;
            }
